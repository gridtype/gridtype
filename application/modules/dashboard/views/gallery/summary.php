<div class="info">
	...
	<p>You have <?php echo $overview['albums']; ?> albums with a total of <?php echo $overview['images']; ?> images </p>
	...
	<p>
        You are using the <b><?php echo LIB; ?></b> 
            ...
            ?> image library
        <br />
        images will be resized to <?php echo GALLERY_MID_W.'x'.GALLERY_MID_H; ?> 
