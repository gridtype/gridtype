...
# Database: gridtype
# Generation Time: 2013-04-14 21:08:32 +0000
# ************************************************************
...
VALUES
	(4,'Typography Work','Typography-Work','Cras justo odio, dapibus ac facilisis in, egestas eget quam. Nulla vitae elit libero, a pharetra augue. Donec sed odio dui. Nullam quis risus eget urna mollis ornare vel eu leo.',0,9996,2),
	(6,'Visual Research','Visual-Research','A Course - My Work',0,9994,4),
	(7,'Some Work Album','Some-Work-Album','Test',0,9993,4),
	(10,'Posters','Posters','Posters',0,9990,1),
	(12,'Gallery 12','gallery_12','',0,9988,0),
	(13,'Gallery 13','gallery_13','0',0,9987,0),
	(14,'Matts Album','Matts-Album','Yo',0,9986,5),
	(15,'Sketches','Sketches','',0,9985,1),
	(16,'Websites','Websites','',0,9984,2),
	(17,'My Infographics','My-Infographics','collection of info graphic posters',0,9983,6);
...
VALUES
	...
	('5472769ee3af84b900d614ed885d5b6c','::1','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_2) AppleWebKit/536.26.14 (KHTML, like Gecko)',1365969783,''),
	...
	('88c1ed136dfd0ff606b90b00bf2d5b3a','::1','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_2) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.65 Safari/537.31',1365973266,'a:1:{s:9:\"user_data\";s:0:\"\";}');
...
VALUES
	(1,13,1,'Donec id elit non mi porta gravida at eget metus. Aenean lacinia bibendum nulla sed consectetur. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.',0,0,'2013-03-21 20:06:07'),
	(2,13,2,'Donec ullamcorper nulla non metus auctor fringilla. Donec sed odio dui. Donec id elit non mi porta gravida at eget metus. Donec ullamcorper nulla non metus auctor fringilla. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum id ligula porta felis euismod semper.',1,0,'2013-03-22 22:06:07'),
	(3,13,1,'asdfasdfa',0,0,'2013-03-22 23:27:47'),
...
VALUES
	...
	(16,7,'Zocalabs Business Card Front','','','/uploads/gallery-7/zl-card-front','.jpg',0,1361927211,4,'2013-02-26 20:06:51',1),
	(17,4,'Typographic Illustration','18x24 Poster made of all typography. For lovers of typography and digital illustration.','Donec id elit non mi porta gravida at eget metus. Nullam quis risus eget urna mollis ornare vel eu leo. Nullam id dolor id nibh ultricies vehicula ut id elit.','/uploads/gallery-4/Steven_Paul_Jobs_by_dylanroscover','.jpg',0,1362528977,2,'2013-03-05 19:16:17',1),
	(22,10,'Degree Infographic',' ',' ','/uploads/gallery-10/csdegree','.jpg',0,1364942040,1,'2013-04-02 18:34:00',0),
	(23,10,'MOOC Infographic',' ',' ','/uploads/gallery-10/mooc-umb-v2','.jpg',0,1364942059,1,'2013-04-02 18:34:19',0),
	(24,15,'Peter Rand - V1',' Website design sketch for a book and author','How does the white background fit on top of the texture background? ','/uploads/gallery-15/about','.jpg',0,1364942263,1,'2013-04-02 18:37:43',0),
	(26,15,'Business Card Back','Business Card backside for a professional development shop','Does the language make sense? ','/uploads/gallery-15/zl-card-back','.jpg',0,1364942358,1,'2013-04-02 18:39:18',0),
	(27,15,'Business Card Front',' Business card front for professional development shop','How does the textured look interact with the type? ','/uploads/gallery-15/zl-card-front','.jpg',0,1364942374,1,'2013-04-02 18:39:34',0),
	(28,15,'My Work is an Awesome Poster',' Poster, 11x17 - 4 color','At this scale is the type legible? How about the color usage for the header graphic? ','/uploads/gallery-15/book-fair-final-part1','.jpg',1,1365040860,1,'2013-04-03 22:01:00',0),
	(29,17,'Chart on some ratings',' ',' ','/uploads/gallery-17/mooc-umb-v2','.jpg',0,1365041108,6,'2013-04-03 22:05:08',1),
	(30,17,'Second Poster of Data','11x17','Is the color appropriate for the audience (18-34)?','/uploads/gallery-17/Screen_Shot_2013-03-24_at_10.10_.54_PM_','.png',0,1365041211,6,'2013-04-03 22:06:51',0);
...
VALUES
	...
	(2,'Bart Simpson','user','bart@simpson.com','5f314545c2f93c0e2f5f07269e82787a631006d1'),
	(3,'Miss Krabappel','faculty','krabappel@school.com','c39f153ca610930f27fafec212321e7ebcd6aef8'),
	(4,'Matthew White','faculty','matt@demo.com','c414b24e0986aeda7d2f73af04d31a3ccb7b9449'),
	(5,'lisa','user','lisa@test.com','6b39bc2757237fe59be26ccfbeeee6eadac92d52'),
	(6,'joetest','user','joe@test.com','f5609ff57c02cd1f5f353877c73f3fba4ff175d7'),
	(7,'edecarol','user','edecarol@lesley.edu ','changemenow'),
	(8,'epervary','user','epervary@lesley.edu ','changemenow'),
	(9,'bgrabow2 ','user','bgrabow2@lesley.edu ','changemenow'),
	(10,'egwozdz2','user','egwozdz2@lesley.edu ','changemenow'),
	(11,'ajiang','user','ajiang@lesley.edu','changemenow'),
	(12,'mkeane2','user','mkeane2@lesley.edu ','changemenow'),
	(13,'jlaurent','user','jlaurent@lesley.edu ','changemenow'),
	(14,'mmead2','user','mmead2@lesley.edu ','changemenow'),
	(15,'petridis','user','petridis@lesley.edu ','changemenow'),
	(16,'cross2','user','cross2@lesley.edu ','changemenow'),
	(17,'prudik','user','prudik@lesley.edu ','changemenow'),
	(18,'rstockma','user','rstockma@lesley.edu ','changemenow'),
	(19,'atobin3','user','atobin3@lesley.edu ','changemenow'),
	(20,'twillett','user','twillett@lesley.edu ','changemenow'),
	(21,'iwolf','user','iwolf@lesley.edu','changemenow'),
	(22,'rbaker6','user','rbaker6@lesley.edu ','changemenow'),
	(23,'cchum','user','cchum@lesley.edu ','changemenow'),
	(24,'lcusack','user','lcusack@lesley.edu ','changemenow'),
	(25,'sdemers','user','sdemers@lesley.edu ','changemenow'),
	(26,'lding','user','lding@lesley.edu ','changemenow'),
	(27,'pdipietr','user','pdipietr@lesley.edu ','changemenow'),
	(28,'mdoan','user','mdoan@lesley.edu ','changemenow'),
	(29,'efalco','user','efalco@lesley.edu ','changemenow'),
	(30,'kkelly13','user','kkelly13@lesley.edu','changemenow'),
	(31,'slizano','user','slizano@lesley.edu ','changemenow'),
	(32,'rmcquade','user','rmcquade@lesley.edu ','changemenow'),
	(33,'lmille16','user','lmille16@lesley.edu ','changemenow'),
	(34,'rrodrig6','user','rrodrig6@lesley.edu ','changemenow'),
	(35,'mtoomaji','user','mtoomaji@lesley.edu ','changemenow'),
	(36,'ctupper','user','ctupper@lesley.edu','changemenow');
